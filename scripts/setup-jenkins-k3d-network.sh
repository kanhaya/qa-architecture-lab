...
log "  Service URL (from Jenkins): http://k3d-qa-lab-server-0:30080"
log ""
log "Ensure Jenkins was started with the Docker socket:"
log "  -v /var/run/docker.sock:/var/run/docker.sock"
